export const createHTML = (content: string, footer: string) => `
<!doctype html>
<html>
  <head>
            ...
            <table role="presentation" class="main" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; background: #ffffff; border-radius: 3px;">
              ...
              <tr>
                <td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px;">
                  ...
                  <tr>
                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; Margin-bottom: 30px;">
                      <img src="https://www.datocms-assets.com/37631/1636623962-logowhite.png" alt="Logo" height="30" border="0" style="border:0; outline:none; text-decoration:none; display:block;">
                    </td>
                  </tr>
                  <tr>
