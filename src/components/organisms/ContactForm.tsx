    ...
    <>
      <Formik
        ...
        validationSchema={Yup.object().shape({
          ...
          email: Yup.string().email('E-mailadres ongeldig.').required('Dit veld is vereist.'),
        })}
          ...
          <Form>
            <div className="flex flex-col sm:flex-row sm:space-x-2">
              <div className="flex-1">
                ...
                <Input name="email" placeholder="E-mail" label="E-mail" type="email" />
              </div>
              <div className="flex-1 flex flex-col mb-4">
                <label htmlFor="message" className="block text-xs mb-2 text-gray-400">
                  Bericht
                </label>
                <Field
                  id="message"
